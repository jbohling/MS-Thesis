...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Evaluation of the Potential for Weld-Related Cracking in Cast 20Cr-32Ni-1Nb Heat-Resistant Stainless Steel}	       % title of thesis/dissertation
...
\keywords{Hot Ductility, Gleeble, 20Cr-32Ni-1Nb, Heat Resistant Alloys, Liquation Cracking}	% keywords (optional) separated by commas - these are used in the PDF file properties
...
\usepackage[utf8]{inputenc} % lets us use umlauts and en dashes in bibliography
\usepackage{csquotes}
...
\usepackage[natbib=true,style=ieee,backref=false,hyperref=true,maxcitenames=2,mincitenames=1,backend=biber,citestyle=numeric-comp]{biblatex}
...
\usepackage{paralist} %provides the compactenum environment for compact lists with less space between items
...
\SmartUnit{metric imperial}

% Rotated page numbers on landscape pages
\usepackage{tikz}
\fancypagestyle{lscapedplain}{
    \fancyhf{}
    \fancyfoot{%
    \tikz[remember picture,overlay]
    \node[outer sep=1in,above,rotate=90] at (current page.east) {\thepage};}
}
