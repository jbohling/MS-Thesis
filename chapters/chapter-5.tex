...
\begin{figure}
    ...
    \caption{Optical micrographs showing the region adjacent to the fracture surface in the Cone~1 On-Heating \SmartUnit{fahrenheit=2375} (C1 OH-2375) hot ductility sample. Evidence of liquation (where melting occurred during the simulated thermal cycle) is denoted by arrows. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Optical micrographs showing liquation around interdendritic phases adjacent to the fracture surface in the Cone~1 On-Heating \SmartUnit{fahrenheit=2375} (C1 OH-2375) hot ductility sample. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{\Gls{sem} micrograph showing liquation around interdendritic phases adjacent to the fracture surface in the Cone~1 On-Heating \SmartUnit{fahrenheit=2375} (C1 OH-2375) hot ductility sample with spot \gls{eds} results for indicated point ``A'' within the melted region. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Optical micrograph showing cracking and liquation in a region adjacent to the fracture surface in the Cone~5 On-Heating \SmartUnit{fahrenheit=2375} (C5 OH-2375) hot ductility sample. The crack tip region is shown in Figure~\ref{fig:c5-oh-2375-crack-100x}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Optical micrographs showing evidence of liquation around interdendritic phases near the fracture surface in the Cone~5 On-Heating \SmartUnit{fahrenheit=2375} (C5 OH-2375) hot ductility sample. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Optical micrograph of a region of the fracture surface in the Cone~1 On-Cooling \SmartUnit{fahrenheit=2300} (C1 OC-2300) hot ductility sample. Note the extensive formation of liquated regions near the surface (e.g. as denoted by arrows). Original magnification, 50X. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Optical micrograph showing a nearly continuous film of prior liquid (arrows) along the fracture surface of the Cone~1 On-Cooling \SmartUnit{fahrenheit=2300} (C1 OC-2300) hot ductility sample, 100X. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption[]{Optical micrograph showing extensive liquation (arrows) along the crack faces and surrounding interdendritic phases, near the tip of the crack visible in Figure~\ref{fig:c1-oc-2300-fracture-panorama} for the Cone~1 On-Cooling \SmartUnit{fahrenheit=2300} (C1 OC-2300) hot ductility sample, 200X. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{\Gls{sem} micrographs showing the region at the tip of the crack visible in Figure~\ref{fig:c1-oc-2300-fracture-panorama} for the Cone~5 On-Heating \SmartUnit{fahrenheit=2375} (C5 OH-2375) hot ductility sample. The \gls{eds} results for the boxed area in (b) are given in Figure~\ref{fig:c1-oc-2300-crack-tip-particles-eds}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption[]{\Gls{sem} micrographs showing evidence of liquation around interdendritic phases adjacent to the fracture surface in the Cone~1 On-Cooling \SmartUnit{fahrenheit=2300} hot ductility sample. \Gls{eds} spot analysis results for the indicated points ``A'' and ``B'' in (b) are given in Figure~\ref{fig:c1-oc-2300-liquid-eds}.}
...
\begin{figure}
    ...
    \caption{Spot \gls{eds} results for the indicated points ``A'' and ``B'' in Figure~\ref{subfig:c1-oc-2300-sem-liquid-5kx} for the Cone~1 On-Cooling \SmartUnit{fahrenheit=2300} (C1 OC-2300) hot ductility sample.}
...
\begin{figure}
    ...
    \caption{Optical micrograph showing a region adjacent to the fracture surface in the Cone~5 On-Cooling \SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Optical micrographs showing the crack visible in Figure~\ref{fig:c5-oc-2300-fracture-50x} for the Cone~5 On-Cooling \SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. Liquated regions around the crack tip and interdendritic phases are denoted by arrows. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{\Gls{sem} micrographs of a crack tip region (cf. Figure~\ref{fig:c5-oc-2300-crack-olm}) in the Cone~5 On-Cooling \SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. The \gls{eds} results for the indicated points ``A'' and ``B'' are given in Figure~\ref{fig:c5-oc-2300-crack-tip-eds}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Spot \gls{eds} results for indicated points ``A'' and ``B'' in Figure~\ref{fig:c5-oc-2300-crack-tip-sem} at a crack tip region in the Cone~5 On-Cooling \SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample.}
...
\begin{figure}
    ...
    \caption{Optical micrographs showing a liquated region adjacent to the fracture surface in the Cone~5 On-Cooling \SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. The boxed region in (b) is examined at higher magnification in Figure~\ref{fig:c5-oc-2300-liquation-sem}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{\glsentryshort{bse}-\gls{sem} micrographs of the boxed region from Figure~\ref{fig:c5-oc-2300-liquation-olm} showing liquation surrounding interdendritic phases in the Cone~5 On-Cooling \SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. \gls{eds} results for the three indicated points in (b) are given in Figure~\ref{fig:c5-oc-2300-liquation-eds}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Spot \gls{eds} results for indicated points ``A'', ``B'', and ``C'' in Figure~\ref{fig:c5-oc-2300-liquation-sem} at a liquated region in the Cone~5 On-Cooling \SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample.}
