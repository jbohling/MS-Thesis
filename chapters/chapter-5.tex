...
\begin{figure}
    ...
    \caption{Optical micrograph showing a nearly continuous film of prior liquid (arrows) along the fracture surface of the Cone~1 On-Cooling \protect\SmartUnit{fahrenheit=2300} (C1 OC-2300) hot ductility sample, 100X. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{\Gls{sem} micrographs showing the region at the tip of the crack visible in Figure~\ref{fig:c1-oc-2300-fracture-panorama} for the Cone~5 On-Heating \protect\SmartUnit{fahrenheit=2375} (C5 OH-2375) hot ductility sample. The \gls{eds} results for the boxed area in (b) are given in Figure~\ref{fig:c1-oc-2300-crack-tip-particles-eds}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Spot \gls{eds} results for the indicated points ``A'' and ``B'' in Figure~\ref{subfig:c1-oc-2300-sem-liquid-5kx} for the Cone~1 On-Cooling \protect\SmartUnit{fahrenheit=2300} (C1 OC-2300) hot ductility sample.}
...
\begin{figure}
    ...
    \caption{Optical micrograph showing a region adjacent to the fracture surface in the Cone~5 On-Cooling \protect\SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{\Gls{sem} micrographs of a crack tip region (cf. Figure~\ref{fig:c5-oc-2300-crack-olm}) in the Cone~5 On-Cooling \protect\SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. The \gls{eds} results for the indicated points ``A'' and ``B'' are given in Figure~\ref{fig:c5-oc-2300-crack-tip-eds}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Spot \gls{eds} results for indicated points ``A'' and ``B'' in Figure~\ref{fig:c5-oc-2300-crack-tip-sem} at a crack tip region in the Cone~5 On-Cooling \protect\SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample.}
...
\begin{figure}
    ...
    \caption{\glsentryshort{bse}-\gls{sem} micrographs of the boxed region from Figure~\ref{fig:c5-oc-2300-liquation-olm} showing liquation surrounding interdendritic phases in the Cone~5 On-Cooling \protect\SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample. \gls{eds} results for the three indicated points in (b) are given in Figure~\ref{fig:c5-oc-2300-liquation-eds}. Etch: electrolytic 10\% oxalic acid.}
...
\begin{figure}
    ...
    \caption{Spot \gls{eds} results for indicated points ``A'', ``B'', and ``C'' in Figure~\ref{fig:c5-oc-2300-liquation-sem} at a liquated region in the Cone~5 On-Cooling \protect\SmartUnit{fahrenheit=2300} (C5 OC-2300) hot ductility sample.}
