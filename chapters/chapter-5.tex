...
\subfloat[Spot Analysis ``B'']{\label{subfig:c1-ar-eds-b}\includegraphics[width=4in]{figures/metallography/c1-ar-eds-table-L3-B.png}}
...
\begin{figure}
\centering
\subfloat[Spot Analysis ``A'']{\label{subfig:c5-ar-eds-a}\includegraphics[width=4in]{}} \\
\subfloat[Spot Analysis ``B'']{\label{subfig:c5-ar-eds-b}\includegraphics[width=4in]{}}
